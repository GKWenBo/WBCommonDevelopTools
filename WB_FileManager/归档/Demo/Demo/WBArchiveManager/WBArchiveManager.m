...
- (BOOL)wb_archiveObjectToFileWithFileName:(NSString *)fileName archiveData:(id)archiveData {
    return [NSKeyedArchiver archiveRootObject:archiveData toFile:[kDocumentPath stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.archive",fileName]]];
}

- (id)wb_unarchiveObjectWithFileName:(NSString *)fileName {
    return [NSKeyedUnarchiver unarchiveObjectWithFile:[kDocumentPath stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.archive",fileName]]];
}
