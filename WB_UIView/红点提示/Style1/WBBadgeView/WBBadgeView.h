...
typedef NS_ENUM(NSInteger,WBBadgeViewAlighnment) {
    WBBadgeViewAlignmentTopLeft = 1,
    WBBadgeViewAlignmentTopRight,
    WBBadgeViewAlignmentTopCenter,
    WBBadgeViewAlignmentCenterLeft,
    WBBadgeViewAlignmentCenterRight,
    WBBadgeViewAlignmentBottomLeft,
    WBBadgeViewAlignmentBottomRight,
    WBBadgeViewAlignmentBottomCenter,
    WBBadgeViewAlignmentCenter
};
...
@property (nonatomic, assign) WBBadgeViewAlighnment badgeAlignment UI_APPEARANCE_SELECTOR;
