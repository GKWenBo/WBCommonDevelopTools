    ...
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            if (_displayLink == nil) {
                ...
                WB_UploadViewSilenceDeprecatedMethodStart();
                _displayLink.frameInterval = 6;
                WB_UploadViewSilenceDeprecatedMethodEnd();
            ...
            WBUploadImageViewCell *sourceCell = (WBUploadImageViewCell *)sourceCollectionViewCell;
